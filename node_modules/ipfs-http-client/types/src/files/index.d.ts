...
export function createFiles(config: import('../types').Options): {
    ...
    write: (path: string, input: string | Uint8Array | AsyncIterable<Uint8Array> | Iterable<Uint8Array> | Blob, options?: (import("ipfs-core-types/src/files").WriteOptions & import("../types").HTTPClientExtraOptions) | undefined) => Promise<void>;
};
