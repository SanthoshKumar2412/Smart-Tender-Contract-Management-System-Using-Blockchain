...
export function createDag(codecs: import('ipfs-core-utils/multicodecs').Multicodecs, config: import('../types').Options): {
    ...
    import: (source: AsyncIterable<Uint8Array> | Iterable<Uint8Array> | AsyncIterable<AsyncIterable<Uint8Array>> | Iterable<AsyncIterable<Uint8Array>>, options?: (import("ipfs-core-types/src/dag").ImportOptions & import("../types").HTTPClientExtraOptions) | undefined) => AsyncIterable<import("ipfs-core-types/src/dag").ImportResult>;
